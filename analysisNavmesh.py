...
if len(sys.argv) != 3:
    print("\nmanual : python3 analysisNavmesh.py <scene_id> <region_id>")
    print("example: python3 analysisNavmesh.py 00800-TEEsavR23oF 1")
    sys.exit(1)
...
# convert to open3d points
pcd = o3d.geometry.PointCloud()
pcd.points = o3d.utility.Vector3dVector(points)
pcd.paint_uniform_color([0.2, 0.8, 0.2])  

# make room bbox based on floor
...
o3d.visualization.draw_geometries([cropped, filtered_pcd])
